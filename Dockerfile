...
RUN mkdir -p /root/scripts/apmodule/ver.4.0/
RUN mkdir /root/bin/
RUN cp -R /sh_tool/bin/   /root/scripts/apmodule/ver.4.0/
RUN cp -R /sh_tool/conf/  /root/scripts/apmodule/ver.4.0/
RUN cp -R /sh_tool/log/   /root/scripts/apmodule/ver.4.0/
RUN rm -Rf /sh_tool/
RUN chmod -R 755 /root/scripts/apmodule/ver.4.0/
RUN ln -s /root/scripts/apmodule/ver.4.0/bin/apmodule.sh /root/bin/apmodule
RUN tree /root/scripts/apmodule/ver.4.0/
