...
Copyright
    ...
    apmodule is distributed in the hope that it will be useful, but
...
htmlhelp_basename: str = 'apmoduledoc'
latex_elements: Dict[Any, Any] = {}
latex_documents: List[Tuple[Any, ...]] = [(
    master_doc, 'apmodule.tex', 'apmodule Documentation',
    'Vladimir Roncevic \\textless{}elektron.ronca@gmail.com\\textgreater{}',
    'manual'
)]
man_pages: List[Tuple[Any, ...]] = [(
    master_doc, 'apmodule', 'apmodule Documentation', [author], 1
)]
texinfo_documents: List[Tuple[Any, ...]] = [(
    master_doc, 'apmodule', 'apmodule Documentation', author, 'apmodule',
