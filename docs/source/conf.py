...
release = u'https://github.com/vroncevic/apmodule/releases/tag/v1.0.0'
...
man_pages = [
    (master_doc, 'apmodule', u'apmodule Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'apmodule', u'apmodule Documentation',
     author, 'apmodule', 'One line description of project.',
     'Miscellaneous'),
]
